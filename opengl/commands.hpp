...
namespace opengl
{
    ...
    public:
        ...
        static auto  draw_vertices(uint32_t primitive, int32_t count, int32_t offset) -> void;
        static auto  draw_elements(uint32_t primitive, int32_t count, int32_t offset) -> void;
