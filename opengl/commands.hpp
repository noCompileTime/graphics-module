...
namespace opengl
{
    ...
    public:
        ...
        static auto viewport(int32_t x, int32_t y, int32_t width, int32_t height)   noexcept -> void; // TODO create a viewport struct? to be used also in the read_pixels and other places?
