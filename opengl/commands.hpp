...
namespace opengl
{
    ...
    {
    public:
        static auto clear(std::uint32_t flags)                noexcept -> void; // TODO mark this as [[maybe_unused]]
        static auto clear(float r, float g, float b, float a) noexcept -> void; // TODO mark this as [[maybe_unused]]
