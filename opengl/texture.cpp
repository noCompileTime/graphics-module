...
namespace opengl
{
    ...
    auto Texture::upload(const int32_t width, const int32_t height, const uint32_t format, const int32_t level, const std::span<const std::byte> buffer) const noexcept -> void
    {
