...
namespace opengl::functions
{
    ...
    using  PFNGLVERTEXARRAYVERTEXBUFFERPROC  = auto(APIENTRY*)(uint32_t vaobj, uint32_t bindingindex, uint32_t buffer, size_t offset, int32_t stride) -> void;
    using  PFNGLVERTEXARRAYELEMENTBUFFERPROC = auto(APIENTRY*)(uint32_t vaobj, uint32_t buffer)                                                       -> void;

    using  PFNGLVERTEXARRAYATTRIBFORMATPROC  = auto(APIENTRY*)(uint32_t vaobj, uint32_t index,  int32_t size, uint32_t type, uint8_t normalized, uint32_t offset) -> void;
    using  PFNGLVERTEXARRAYATTRIBBINDINGPROC = auto(APIENTRY*)(uint32_t vaobj, uint32_t index, uint32_t binding)                                                  -> void;
    using  PFNGLENABLEVERTEXARRAYATTRIBPROC  = auto(APIENTRY*)(uint32_t vaobj, uint32_t index)                                                                    -> void;
