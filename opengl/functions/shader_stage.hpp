...
namespace opengl::functions
{
    ...
    using  PFNGLSPECIALIZESHADERPROC = auto(APIENTRY*)(uint32_t shader, const char* entry_point, uint32_t constants, const uint32_t* indices, const uint32_t* values) -> void;
